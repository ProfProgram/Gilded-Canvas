...
/>
    ...
    <link rel="icon" type="image/x-icon" href="<?php echo e(asset('images/TGC-Black-and-Gold.png')); ?>">
...
<body>
    <header>
        <nav id="navbar">
            <a url="/home">
            <img id="navbar-logo" src="<?php echo e(asset('images/TGC-Black-and-Gold.png')); ?>" alt="The Gilded Canvas Logo">
            </a>
            <!-- connected pages -->
            <!-- public links -->
            <a href="/home">Home</a>
            ...
            <?php if(auth()->guard()->check()): ?>
                <a href="/basket" class="cart-icon">
                    <img src="<?php echo e(asset('images/cart-icon.png')); ?>" alt="Shopping Cart" class="cart-icon-img">
                ...
                <?php if(Auth::user()->role === \App\Enums\UserRole::admin): ?>
                    <a href="<?php echo e(route('admin.inventory')); ?>">Admin Panel</a>
                <?php endif; ?>
                <?php if(Auth::user()->role === \App\Enums\UserRole::manager): ?>
                    <a href="<?php echo e(route('manager.users')); ?>">Manage Users</a>
                <?php endif; ?>
        ...
        <div style="text-align: right; margin-bottom: 15px; min-width: 150px;">
            ...
            <div style="display: flex; justify-content: flex-end; gap: 10px;">
                <a href="https://www.facebook.com" target="_blank">
                    <img src="<?php echo e(asset('images/facebook-logo.png')); ?>" alt="Facebook" style="width: 30px; height: auto;">
                </a>
                <a href="https://www.instagram.com" target="_blank">
                    <img src="<?php echo e(asset('images/instagram-icon.png')); ?>" alt="Instagram" style="width: 30px; height: auto;">
                </a>
                <a href="https://www.twitter.com" target="_blank">
                    <img src="<?php echo e(asset('images/twitter-icon.png')); ?>" alt="Twitter" style="width: 30px; height: auto;">
                </a>
            </div>
        </div>
    </footer>
    <script rel="script" src="<?php echo e(asset('js/js.js')); ?>"></script>
</body>
</html>
<?php /**PATH C:\Users\adams\Documents\GitHub\Gilded-Canvas\TheGuildedCanvas\resources\views/layouts/master.blade.php ENDPATH**/ ?>