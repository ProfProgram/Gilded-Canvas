	...
	<main id="about-main">
	    ...
	    <section class="introduction">
	        <h2 id="headers-about">About Us</h2>
	        <p id="para-about">
	    ...
	    <section class="mission">
	        <h2 id="headers-about">Our Mission</h2>
	        <p id="para-about">
	    ...
	    <!-- Team Section -->
	    <section class="team">
	        <h2 id="headers-about">Meet Our Team</h2>
	        <p id="para-about">
...
<?php echo $__env->make('layouts.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\adams\Documents\GitHub\Gilded-Canvas\TheGuildedCanvas\resources\views/about-us.blade.php ENDPATH**/ ?>