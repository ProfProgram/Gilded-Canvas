...
return new class extends Migration
{
    ...
    public function up(): void
    {
         ...
         */
        if (!Schema::hasTable('Admin Table')) {
         ...
         * does not require foreign keys
         */
        if (!Schema::hasTable('Products Table')) {
         ...
         */
        if (!Schema::hasTable('Inventory Table')) {
         ...
         * */
        if (!Schema::hasTable('Orders Details Table')) {
         ...
         */
        if (!Schema::hasTable('Reviews Table')) {
         ...
         * */
        if (!Schema::hasTable('Returns Table')) {
